...
export interface ApiProductCategoryProductCategory
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    product_sub_categories: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProductReviewProductReview
  ...
  attributes: {
    ...
    reviewdesc: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ProductPrice: Schema.Attribute.BigInteger;
    ProductStock: Schema.Attribute.Integer;
    productvariants: Schema.Attribute.Relation<
      'oneToMany',
      'api::productvariant.productvariant'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductvariantProductvariant
  ...
  attributes: {
    ...
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    productavailable: Schema.Attribute.Boolean;
    productvariantimages: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    SKU: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'SKU'>;
    stockquantity: Schema.Attribute.BigInteger;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::productvariant.productvariant': ApiProductvariantProductvariant;
